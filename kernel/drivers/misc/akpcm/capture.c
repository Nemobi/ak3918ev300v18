...
/**
 * @brief  start the ADC for capture
 * @author panqihe 2014-06-11
 * @modify
 * @return void
 */
...
static inline void sync_dac(struct akpcm *pcm)
{
    struct akpcm_runtime *rt = pcm->cptr_rt;
    u_int64_t end = 0;
	//u_int64_t start = ak39_gethrtick();
...
/**
 * @brief  prepare for capture(open ADC2, power on MIC).
