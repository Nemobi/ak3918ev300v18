...
typedef enum
{
    ...
    EVENT_TYPE_LOW_BATTERY = 18,     /*low_battery*/
    EVENT_TYPE_NOUSE = 19,           /*ignore it.*/
    EVENT_TYPE_COVER = 20,           /* ipc cover pic*/
    EVENT_TYPE_FULL_BATTERY = 21,    /* full battery*/
    EVENT_TYPE_USER_IO = 22,         /* io alarm 2*/
    EVENT_TYPE_INVALID
